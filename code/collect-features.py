...
def get_audio_info(tracks_chunk, access_token):
    ...
    for audio_features_dict in audio_features_dicts:
        if audio_features_dict == None:
            ...
            audio_info = [danceability, energy, key, loudness, modality, energy, valence, speechiness]
...
def main():
    ...
    header = ['album_id', 'album_name', 'cover_location', 'artist', 'track_id', 'track_name', 'popularity', 'explicit', 'danceability', 'energy', 'key', 'loudness', 'modality', 'energy', 'valence', 'speechiness', 'genre']
    ...
    with open(os.path.join(data_path, 'data-train.csv'), 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(header)
        writer.writerows(data_train)
    
    with open(os.path.join(data_path, 'data-test.csv'), 'w', newline='') as f:
        writer = csv.writer(f)
        writer.writerow(header)
